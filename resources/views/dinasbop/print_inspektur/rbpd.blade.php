					...
					<center>
						<table width="100%">
							<tr>
								...
								<td style="width:20%;">: {!! $dinasbopinspektur->dinasbop->kegiatan->kode_kegiatan !!}</td>
							</tr>
							<tr>
								<td style="width:5%;">Lampiran SPD Nomor</td>
								<td style="width:20%;">: {!! $dinasbopinspektur->nomor_sp !!}</td>
							...
							<tr>
								...
								<td style="width:20%;">: {!! Carbon\Carbon::parse($dinasbopinspektur->tgl_sp)->formatLocalized('%d %B %Y') !!}</td>
								<td style="width:2%;">Kodering</td>
								<td style="width:20%;">: {!! $dinasbopinspektur->dinasbop->belanja->kode_belanja !!}</td>
							</tr>
						</table>
					</center>
					<br>
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td colspan="3">
										Perjalanan Dinas {!! $dinasbopinspektur->dinasbop->kegiatan->nama_kegiatan !!}, selama {!! $durasi !!} hari dari tanggal {!! Carbon\Carbon::parse($dinasbopinspektur->dari)->formatLocalized('%d %B %Y') !!}
										s.d {!! Carbon\Carbon::parse($dinasbopinspektur->sampai)->formatLocalized('%d %B %Y') !!}.
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<table width="100%" class="table-print table table-borderless">
										<tr>
											<td style="width:20%;vertical-align:middle;">{!! $dinasbopinspektur->inspektur['nama'] !!}</td>
											<td style="width:20%;text-align:center;vertical-align:middle;">Penanggungjawab</td>
											<td style="width:15%;text-align:center;vertical-align:middle;">
												{!! $dinasbopinspektur->inspektur['golongan'] !!}
											</td>
											<td style="width:4%;text-align:center;vertical-align:middle;">
												{!! $dinasbopinspektur->inspektur['hari'] !!} hari
											</td>
											<td style="width:1%;text-align:center;vertical-align:middle;">x</td>
											<td style="width:10%;vertical-align:middle;">
												Rp.{!! $common->rupiah($dinasbopinspektur->inspektur['biaya']) !!}
											</td>
										</tr>
									</table>
								</td>
									...
									<table width="100%" class="table-print table table-borderless">
										<tr>
											<td style="text-align:right;vertical-align:middle;">
												Rp.{!! $common->rupiah($dinasbopinspektur->inspektur['total']) !!}
											</td>
										</tr>
									</table>
								</td>
						...
						<tr>
							<td width="25%">
								<table cellpadding="2" cellspacing="2" style="width:100%;">
									...
									<tr>
										<td width="10%" style="text-align: center;">
											NIP. {!! $dinasbopinspektur->dinasbop->kegiatan->pegawai->nip !!}
										</td>
									</tr>
								</table>
							</td>
							<td width="25%">
								<table cellpadding="2" cellspacing="2" style="width:100%;">
									...
									<tr>
										<td width="10%" style="text-align: center;">
											{!! $dinasbopinspektur->inspektur['nama'] !!}
										</td>
									</tr>
									<tr>
										<td width="10%" style="text-align: center;">
											NIP. {!! $dinasbopinspektur->inspektur['nip'] !!}
										</td>
									</tr>
								</table>
							</td>
