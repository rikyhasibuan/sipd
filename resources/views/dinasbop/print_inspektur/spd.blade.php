...
$diff = date_diff($dinasbopinspektur->dinasbop->dari, $dinasbopinspektur->dinasbop->sampai);
$durasi = $diff->days;
$kpa = $timdinas->get_sekretaris();
$total = $dinasbopinspektur->dinasbop->total_anggaran;
?>
    <!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <table class="table table-bordered" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    {!! $dinasbopinspektur->inspektur['nama'] !!}<br>
                                    {!! $dinasbopinspektur->inspektur['nip'] !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    {!! $dinasbopinspektur->inspektur['pangkat'] !!}
                                    {!! $dinasbopinspektur->inspektur['golongan'] !!}<br>
                                    Penanggungjawab<br>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">{!! $dinasbopinspektur->tujuan[0] !!}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">Kota Bandung<br> {!! $dinasbopinspektur->dinasbop->auditan !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    ...
                                    {!! $common->generate_indonesia_date($dinasbopinspektur->dari) !!} <br>
                                    {!! $common->generate_indonesia_date($dinasbopinspektur->sampai) !!}
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td width="10%" style="text-align: right;">
                                                {!! $common->generate_indonesia_date($dinasbopinspektur->tgl_sp) !!}</td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%;">
                                        <tr>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    ...
                                    <tr>
                                        ...
                                        <td>: {!! $common->generate_indonesia_date($dinasbopinspektur->dari) !!}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td>: {!! $dinasbopinspektur->dinasbop->auditan !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:2%;"></td>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td>
                                            : {!! $dinasbopinspektur->dinasbop->auditan !!}<br>
                                            : Kota Bandung
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:60%;">Pada Tanggal</td>
                                        <td>: {!! $common->generate_indonesia_date($dinasbopinspektur->sampai) !!}</td>
                                    </tr>
                                    <tr>
