        ...
        <div class="col-md-12">
            ...
            <center>
                <table width="75%">
                    <tr>
                        ...
                        <td style="width:70%;vertical-align: top;text-align: justify;">PENERIMAAN BIAYA OPERASIONAL INSPEKTORAT BELANJA {!! strtoupper($timadministrasi->dinasbopadministrasi->dinasbop->belanja->nama_belanja) !!} SELAMA {!! $durasi !!} ({!! strtoupper($common->terbilang($durasi)) !!}) HARI MULAI TANGGAL {!! strtoupper($common->generate_indonesia_date($timadministrasi->dinasbopadministrasi->dari)) !!} SAMPAI DENGAN {!! strtoupper($common->generate_indonesia_date($timadministrasi->dinasbopadministrasi->sampai)) !!} UNTUK MELAKUKAN {!! strtoupper($timadministrasi->dinasbopadministrasi->dinasbop->program->nama_program) !!} PADA {!! strtoupper($timadministrasi->auditan) !!}</td>
                    </tr>
                </table>
            </center>
            <br>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>{!! $timadministrasi->tim['ketuatim']['nama'] !!}</td>
                    <td style="text-align: center;">KETUA TIM {!! $timadministrasi->tim['ketuatim']['golongan'] !!}</td>
                    <td style="text-align: right;">Rp.{!! $common->rupiah($timadministrasi->tim['ketuatim']['total']) !!}</td>
                    <td></td>
                    <td></td>
                    <td style="text-align: right;">Rp.{!! $common->rupiah($timadministrasi->tim['ketuatim']['total']) !!}</td>
                    <td></td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;"><b>Rp.{!! $common->rupiah($timadministrasi->total_anggaran) !!}</b></td>
                    <td></td>
                </tr>
                </tbody>
            </table>
            Terbilang : <i>{!! $common->terbilang($timadministrasi->total_anggaran) !!} rupiah *</i>
            <br><br>
            <table width="100%">
                <tr>
                    <td width="25%"></td>
                    <td width="25%">
                        <center>
                            <table cellpadding="2" cellspacing="2">
                                <tr>
                                    <td width="10%" style="text-align: center;">Bandung, {!! $common->generate_indonesia_date($timadministrasi->tgl_sp) !!}</td>
                                </tr>
                            </table>
                        </center>
                    </td>
                ...
                <tr>
                    ...
                    <td width="25%">
                        <table cellpadding="2" cellspacing="2" style="width:100%;">
                            ...
                            <tr>
                                <td width="10%" style="text-align: center;">{!! $timadministrasi->dinasbopadministrasi->dinasbop->kegiatan->pegawai->pangkat !!}</td>
                            </tr>
                            <tr>
                                <td width="10%" style="text-align: center;">NIP. {!! $timadministrasi->dinasbopadministrasi->dinasbop->kegiatan->pegawai->nip !!}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
