                        ...
                        <table class="table table-bordered" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    {!! $timadministrasi->tim['ketuatim']['nama'] !!}<br>
                                    {!! $timadministrasi->tim['ketuatim']['nip'] !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    {!! $timadministrasi->tim['ketuatim']['pangkat'] !!}
                                    {!! $timadministrasi->tim['ketuatim']['golongan'] !!}<br>
                                    Ketua Tim<br>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">{!! $timadministrasi->dinasbopadministrasi->untuk[0] !!}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">Kota Bandung<br> {!! $timadministrasi->auditan !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    ...
                                    {!! $common->generate_indonesia_date($timadministrasi->dinasbopadministrasi->dari) !!} <br>
                                    {!! $common->generate_indonesia_date($timadministrasi->dinasbopadministrasi->sampai) !!}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <ol style="margin-left: -30px;">
                                        @for($i = 0; $i < count($timadministrasi->tim['anggota']); $i++)
                                            <li>{!! $timadministrasi->tim['anggota'][$i]['nama'] !!}</li>
                                        @endfor
                                    </ol>
                                </td>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td width="10%" style="text-align: right;">
                                                {!! $common->generate_indonesia_date($timadministrasi->tgl_sp) !!}
                                            </td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%;">
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    ...
                                    <tr>
                                        ...
                                        <td>: {!! $common->generate_indonesia_date($timadministrasi->dinasbopadministrasi->dari) !!}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td>
                                            : {!! $timadministrasi->auditan !!}<br>
                                            : Kota Bandung
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:25%;">Pada Tanggal</td>
                                        <td>: {!! $common->generate_indonesia_date($timadministrasi->dinasbopadministrasi->sampai) !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:25%;">Kepala</td>
                                        <td>:</td>
                            ...
                            <td colspan="2">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td style="width:20%;">Tiba kembali di </td>
                                        <td>: Kota Bandung</td>
                                    </tr>
                                    <tr>
                                        <td style="width:2%;"></td>
                                        <td style="width:20%;">Pada Tanggal</td>
                                        <td>: {!! $common->generate_indonesia_date($timadministrasi->sampai) !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:2%;"></td>
                                        <td colspan="2">
