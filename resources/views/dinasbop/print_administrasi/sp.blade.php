    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <h4 class="text-center">No. {!! $timadministrasi->nomor_sp !!}</h4>
                ...
                <div style="padding-left:0.5cm;padding-right:0.5cm;">
                        ...
                        <tr>
                            ...
                            <td width="80%" style="text-align: justify; vertical-align:text-top;">
                                <table cellpadding="2" cellspacing="2" style="width:100%;table-layout:fixed;">
                                    @if(count($timadministrasi->dinasbopadministrasi->dinasbop->dasar) > 1)
                                        <?php $n = 0; ?>
                                        @foreach($timadministrasi->dinasbopadministrasi->dinasbop->dasar as $v)
                                            <tr>
                                    ...
                                    @else
                                        <tr>
                                            <td width="100%" style="text-align: justify; vertical-align:text-top;">
                                                {!! $timadministrasi->dinasbopadministrasi->dasar[0] !!}
                                            </td>
                                        </tr>
                                    @endif
                                </table>
                    ...
                    <table cellpadding="2" cellspacing="2" style="width:100%;">
                        <tr>
                            ...
                            <td width="80%" style="text-align: justify;">
                                ...
                                <span style="margin-right:20px;">{!! $timadministrasi->tim['ketuatim']['nama'] !!}</span>
                                <br>
                                <span style="margin-right:35px;"></span>
                                <span style="margin-right:63px;">NIP</span>
                                <span style="margin-right:30px;">:</span>
                                <span style="margin-right:20px;">{!! $timadministrasi->tim['ketuatim']['nip'] !!}</span>
                                <br>
                                <span style="margin-right:35px;"></span>
                                ...
                                <?php $i = 1; ?>
                                @foreach($timadministrasi->tim['anggota'] as $anggota)
                    ...
                    <table cellpadding="2" cellspacing="2" style="width:100%;">
                        <tr>
                            ...
                            <td width="80%" style="text-align: justify; vertical-align:text-top;">
                                <table cellpadding="2" cellspacing="2" style="width:100%;table-layout:fixed;">
                                    @if(count($timadministrasi->dinasbopadministrasi->untuk) > 1)
                                        <?php $n = 0; ?>
                                        @foreach($timadministrasi->dinasbopadministrasi->untuk as $v)
                                            <tr>
                                                <td width="3%" style="text-align: left; vertical-align:text-top;">{!! ++$n !!}.</td>
                                                <td width="95%" style="text-align: justify; vertical-align:text-top;">
                                                    {!! $v !!}
                                    ...
                                    @else
                                        <tr>
                                            <td width="95%" style="text-align: justify; vertical-align:text-top;">
                                                {!! $timadministrasi->dinasbopadministrasi->untuk[0] !!}
                                            </td>
                                        </tr>
                                    @endif
                                </table>
                    ...
                    <table cellpadding="2" cellspacing="2" style="width:100%;">
                        <tr>
                            ...
                            <td width="5%" style="text-align: center; vertical-align:text-top;">:</td>
                            <td width="80%" style="text-align: justify; vertical-align:text-top;">
                                Mulai tanggal {!! $common->generate_indonesia_date($timadministrasi->dinasbopadministrasi->dari) !!}
                                sampai {!! $common->generate_indonesia_date($timadministrasi->dinasbopadministrasi->sampai) !!}
                            </td>
                        </tr>
                    </table>
                            ...
                            <td width="30%">
                                <table cellpadding="2" cellspacing="2" style="width:100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td width="10%" style="text-align: right;">{!! $common->generate_indonesia_date($timadministrasi->tgl_sp) !!}</td>
                                    </tr>
                                </table>
                                <table cellpadding="2" cellspacing="2" style="width:100%;">
                                    <tr>
