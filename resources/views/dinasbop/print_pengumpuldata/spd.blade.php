                    ...
                    <div >
                        <table class="table table-bordered" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">{!! $timpengumpuldata->dinasboppengumpuldata->untuk[0] !!}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">Kota Bandung<br> {!! $timpengumpuldata->auditan !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    ...
                                    {!! $common->generate_indonesia_date($timpengumpuldata->dinasboppengumpuldata->dari) !!} <br>
                                    {!! $common->generate_indonesia_date($timpengumpuldata->dinasboppengumpuldata->sampai) !!}
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td width="10%" style="text-align: right;">
                                                {!! $common->generate_indonesia_date($timpengumpuldata->tgl_sp) !!}
                                            </td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%;">
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    ...
                                    <tr>
                                        ...
                                        <td>: {!! $common->generate_indonesia_date($timpengumpuldata->dinasboppengumpuldata->dari) !!}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td>: {!! $timpengumpuldata->auditan !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:2%;"></td>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td>
                                            : {!! $timpengumpuldata->auditan !!}<br>
                                            : Kota Bandung
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:25%;">Pada Tanggal</td>
                                        <td>: {!! $common->generate_indonesia_date($timpengumpuldata->dinasboppengumpuldata->sampai) !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:25%;">Kepala</td>
                                        <td>:</td>
                            ...
                            <td colspan="2">
                                <table class="table-print">
                                    ...
                                    <tr>
                                        ...
                                        <td>: {!! $common->generate_indonesia_date($timpengumpuldata->sampai) !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:2%;"></td>
                                        <td colspan="2">
