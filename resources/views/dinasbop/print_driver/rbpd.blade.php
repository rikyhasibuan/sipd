							...
							<tr>
								...
								<td>
									<table width="100%" class="table-print table table-borderless">
										<tr>
											<td style="width:20%;vertical-align:middle;">{!! $dinasbopdriver->driver['nama'] !!}</td>
											<td style="width:20%;text-align:center;vertical-align:middle;">Pengemudi</td>
											<td style="width:15%;text-align:center;vertical-align:middle;">
												{!! $dinasbopdriver->driver['golongan'] !!}
											</td>
											<td style="width:4%;text-align:center;vertical-align:middle;">
												{!! $dinasbopdriver->driver['hari'] !!} hari
											</td>
											<td style="width:1%;text-align:center;vertical-align:middle;">x</td>
											<td style="width:10%;vertical-align:middle;">
												Rp.{!! $common->rupiah($dinasbopdriver->driver['biaya']) !!}
											</td>
										</tr>
									</table>
								</td>
									...
									<table width="100%" class="table-print table table-borderless">
										<tr>
											<td style="text-align:right;vertical-align:middle;">
												Rp.{!! $common->rupiah($dinasbopdriver->driver['total']) !!}
											</td>
										</tr>
									</table>
								</td>
						...
						<tr>
							<td width="25%">
								<table cellpadding="2" cellspacing="2" style="width:100%;">
									...
									<tr>
										<td width="10%" style="text-align: center;">
											NIP. {!! $dinasbopdriver->dinasbop->kegiatan->pegawai->nip !!}
										</td>
									</tr>
								</table>
							</td>
							<td width="25%">
								<table cellpadding="2" cellspacing="2" style="width:100%;">
									...
									<tr>
										<td width="10%" style="text-align: center;">
											{!! $dinasbopdriver->driver['nama'] !!}
										</td>
									</tr>
									<tr>
										<td width="10%" style="text-align: center;">
											NIP. {!! $dinasbopdriver->driver['nip'] !!}
										</td>
									</tr>
								</table>
							</td>
