...
$dari = date_create($dinasbopdriver->dari);
$sampai = date_create($dinasbopdriver->sampai);
				...
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td>{!! $dinasbopdriver->driver['nama'] !!}</td>
							<td style="text-align: center;">PENGEMUDI {!! $dinasbopdriver->driver['golongan'] !!}</td>
							<td style="text-align: right;">Rp.{!! $common->rupiah($dinasbopdriver->driver['total']) !!}</td>
							<td></td>
							<td></td>
							<td style="text-align: right;">Rp.{!! $common->rupiah($dinasbopdriver->driver['total']) !!}</td>
							<td></td>
						...
						<tr>
							...
							<td style="text-align: right;"><b>Rp.{!! $common->rupiah($dinasbopdriver->total) !!}</b></td>
							<td></td>
						</tr>
					</tbody>
				</table>
				Terbilang : <i>{!! $common->terbilang($dinasbopdriver->total) !!} rupiah *</i>
				<br><br>
				<table width="100%">
					<tr>
						<td width="25%"></td>
					...
					<tr>
							...
							<td width="25%">
								<table cellpadding="2" cellspacing="2" style="width:100%;">
									...
									<tr>
											<td width="10%" style="text-align: center;">{!! $dinasbopdriver->dinasbop->kegiatan->pegawai->nama !!}</td>
									</tr>
									<tr>
											<td width="10%" style="text-align: center;">{!! $dinasbopdriver->dinasbop->kegiatan->pegawai->pangkat !!}</td>
									</tr>
									<tr>
											<td width="10%" style="text-align: center;">NIP. {!! $dinasbopdriver->dinasbop->kegiatan->pegawai->nip !!}</td>
									</tr>
								</table>
							</td>
					</tr>
