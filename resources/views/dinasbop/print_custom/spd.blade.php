                    ...
                    <div >
                        <table class="table table-bordered" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">{!! $dinasbopcustom->dinasbop->untuk[0] !!}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">Kota Bandung<br> {!! $dinasbopcustom->auditan !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    ...
                                    {!! $common->generate_indonesia_date($dinasbopcustom->dinasbop->dari) !!} <br>
                                    {!! $common->generate_indonesia_date($dinasbopcustom->dinasbop->sampai) !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="30%">
                                    <ol style="margin-left: -30px;">
                                        ...
                                        @for($i = 0; $i < count($dinasbopcustom->tim['anggota']); $i++)
                                            <li>{!! $dinasbopcustom->tim['anggota'][$i]['nama'] !!}</li>
                                        @endfor
                                    </ol>
                                </td>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td width="10%" style="text-align: right;">
                                                {!! $common->generate_indonesia_date($dinasbopcustom->tgl_sp) !!}
                                            </td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%;">
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    ...
                                    <tr>
                                        ...
                                        <td>: {!! $common->generate_indonesia_date($dinasbopcustom->dinasbop->dari) !!}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td>
                                            : {!! $dinasbopcustom->auditan !!}<br>
                                            : Kota Bandung
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:25%;">Pada Tanggal</td>
                                        <td>: {!! $common->generate_indonesia_date($dinasbopcustom->dinasbop->sampai) !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:25%;">Kepala</td>
                                        <td>:</td>
                            ...
                            <td colspan="2">
                                <table class="table-print">
                                    ...
                                    <tr>
                                        <td style="width:2%;"></td>
                                        <td style="width:25%;">Pada Tanggal</td>
                                        <td>: {!! $common->generate_indonesia_date($dinasbopcustom->sampai) !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:2%;"></td>
                                        <td colspan="2">
