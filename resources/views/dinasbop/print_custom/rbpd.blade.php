...
$total = $dinasbopcustom->dinasbop->total_anggaran;
?>
<!DOCTYPE html>
<html lang="en">
  <head>
					...
					<center>
						<table width="100%">
							...
							<tr>
								...
								<td style="width:20%;">: {!! $dinasbopcustom->dinasbop->nomor_sp !!}</td>
								<td style="width:2%;">Tanggal BKU</td>
								<td style="width:20%;">: </td>
							</tr>
							<tr>
								<td style="width:5%;">Tanggal</td>
								<td style="width:20%;">: {!! $common->generate_indonesia_date($dinasbopcustom->tgl_sp) !!}</td>
								<td style="width:2%;">Kodering</td>
								<td style="width:20%;">: {!! $dinasbopcustom->dinasbop->belanja->kode_belanja !!}</td>
							</tr>
						</table>
					</center>
					<br>
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td colspan="3">
										Perjalanan Dinas {!! $dinasbopcustom->dinasbop->kegiatan->nama_kegiatan !!}, selama {!! $durasi !!} hari dari tanggal {!! $common->generate_indonesia_date($dinasbopcustom->dinasbop->dari) !!}
										s.d {!! $common->generate_indonesia_date($dinasbopcustom->dinasbop->sampai) !!}.
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<table width="100%" class="table-print table table-borderless">
										...
										<tr>
											...
											<td style="width:15%;text-align:center;vertical-align:middle;">
												{!! $dinasbopcustom->tim['wakilpenanggungjawab']['golongan'] !!}
											</td>
											<td style="width:4%;text-align:center;vertical-align:middle;">
												{!! $dinasbopcustom->tim['wakilpenanggungjawab']['hari'] !!} hari
											</td>
											<td style="width:1%;text-align:center;vertical-align:middle;">x</td>
											<td style="width:10%;vertical-align:middle;">
												Rp.{!! $common->rupiah($dinasbopcustom->tim['wakilpenanggungjawab']['biaya']) !!}
											</td>
										</tr>
										<tr>
											<td style="width:20%;vertical-align:middle;">{!! $dinasbopcustom->tim['pengendaliteknis']['nama'] !!}</td>
											<td style="width:20%;text-align:center;vertical-align:middle;">Pengendali Teknis</td>
											<td style="width:15%;text-align:center;vertical-align:middle;">
												{!! $dinasbopcustom->tim['pengendaliteknis']['golongan'] !!}
											</td>
											<td style="width:4%;text-align:center;vertical-align:middle;">
												{!! $dinasbopcustom->tim['pengendaliteknis']['hari'] !!} hari
											</td>
											<td style="width:1%;text-align:center;vertical-align:middle;">x</td>
											<td style="width:10%;vertical-align:middle;">
												Rp.{!! $common->rupiah($dinasbopcustom->tim['pengendaliteknis']['biaya']) !!}
											</td>
										</tr>
										<tr>
											<td style="width:20%;vertical-align:middle;">{!! $dinasbopcustom->tim['ketuatim']['nama'] !!}</td>
											<td style="width:20%;text-align:center;vertical-align:middle;">Ketua Tim</td>
											<td style="width:15%;text-align:center;vertical-align:middle;">
												{!! $dinasbopcustom->tim['ketuatim']['golongan'] !!}
											</td>
											<td style="width:4%;text-align:center;vertical-align:middle;">
												{!! $dinasbopcustom->tim['ketuatim']['hari'] !!} hari
											</td>
											<td style="width:1%;text-align:center;vertical-align:middle;">x</td>
											<td style="width:10%;vertical-align:middle;">
												Rp.{!! $common->rupiah($dinasbopcustom->tim['ketuatim']['biaya']) !!}
											</td>
										</tr>
								...
								<td>
									<table width="100%" class="table-print table table-borderless">
										...
										<tr>
											<td style="text-align:right;vertical-align:middle;">
												Rp.{!! $common->rupiah($dinasbopcustom->tim['pengendaliteknis']['total']) !!}
											</td>
										</tr>
										<tr>
											<td style="text-align:right;vertical-align:middle;">
												Rp.{!! $common->rupiah($dinasbopcustom->tim['ketuatim']['total']) !!}
											</td>
										</tr>
										@foreach($dinasbopcustom->tim['anggota'] as $v)
											<tr>
							...
							<tr>
								...
								<td style="text-align: right;vertical-align:middle;">
									<b>Rp.{!! $common->rupiah($dinasbopcustom->total_anggaran) !!}</b>
								</td>
								<td></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="text-align: right; vertical-align:middle;"><b>Rp.{!! $common->rupiah(($dinasbopcustom->total_anggaran) ) !!}</b></td>
								<td></td>
							</tr>
							<tr>
								<td colspan="4"><b><i>{!! $common->terbilang($dinasbopcustom->total_anggaran) !!} Rupiah</i></b></td>
							</tr>
						</tbody>
					</table>
					<table width="100%">
									...
									<table cellpadding="2" cellspacing="2" style="width:30%;">
										<tr>
											<td width="10%" style="text-align: center;">
												Bandung, {!! $common->generate_indonesia_date($dinasbopcustom->tgl_sp) !!}
											</td>
										</tr>
									</table>
								</center>
						...
						<tr>
							<td width="25%">
								<table cellpadding="2" cellspacing="2" style="width:100%;">
									...
									<tr>
										<td width="20%" style="text-align: center;">Rp.{!! $common->rupiah($dinasbopcustom->total_anggaran) !!}</td>
									</tr>
									<tr>
									...
									<tr>
										<td width="10%" style="text-align: center;">
											NIP. {!! $dinasbopcustom->dinasbop->kegiatan->pegawai->nip !!}
										</td>
									</tr>
								</table>
							</td>
							<td width="25%">
								<table cellpadding="2" cellspacing="2" style="width:100%;">
									...
									<tr>
										<td width="20%" style="text-align: center;">
											Rp.{!! $common->rupiah($dinasbopcustom->total_anggaran) !!}
										</td>
									</tr>
									<tr>
									...
									<tr>
										<td width="10%" style="text-align: center;">
											{!! $dinasbopcustom->tim['anggota'][0]['nama'] !!}
										</td>
									</tr>
									<tr>
										<td width="10%" style="text-align: center;">
											NIP. {!! $dinasbopcustom->tim['anggota'][0]['nip'] !!}
										</td>
									</tr>
								</table>
							</td>
					...
					<div class="col-lg-12">
						...
						<table width="100%">
							<tr>
								...
								<td width="10%" style="text-align:right;">Rp.{!! $common->rupiah(($dinasbopcustom->total_anggaran) ) !!}</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td width="5%" style="text-align:right;">Rp.{!! $common->rupiah(($dinasbopcustom->total_anggaran) ) !!}</td>
							</tr>
						</table>
