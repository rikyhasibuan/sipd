                        ...
                        <table class="table table-bordered" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    {!! $dinasbopsupervisi->tim['ketuatim']['nama'] !!}<br>
                                    {!! $dinasbopsupervisi->tim['ketuatim']['nip'] !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    {!! $dinasbopsupervisi->tim['ketuatim']['pangkat'] !!}
                                    {!! $dinasbopsupervisi->tim['ketuatim']['golongan'] !!}<br>
                                    Ketua Tim<br>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">{!! $dinasbopsupervisi->tujuan[0] !!}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    ...
                                    {!! $common->generate_indonesia_date($dinasbopsupervisi->dari) !!} <br>
                                    {!! $common->generate_indonesia_date($dinasbopsupervisi->sampai) !!}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <ol style="margin-left: -30px;">
                                        @for($i = 0; $i < count($dinasbopsupervisi->tim['anggota']); $i++)
                                            <li>{!! $dinasbopsupervisi->tim['anggota'][$i]['nama'] !!}</li>
                                        @endfor
                                    </ol>
                                </td>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td width="10%" style="text-align: right;">
                                                {!! $common->generate_indonesia_date($dinasbopsupervisi->tgl_sp) !!}
                                            </td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%;">
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    ...
                                    <tr>
                                        ...
                                        <td>: {!! $common->generate_indonesia_date($dinasbopsupervisi->dari) !!}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    ...
                                    <tr>
                                        <td style="width:25%;">Pada Tanggal</td>
                                        <td>: {!! $common->generate_indonesia_date($dinasbopsupervisi->sampai) !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:25%;">Kepala</td>
                                        <td>:</td>
