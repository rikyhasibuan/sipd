					...
					<center>
						<table width="100%">
							<tr>
								...
								<td style="width:20%;">: {!! $dinasbopsekretaris->dinasbop->kegiatan->kode_kegiatan !!}</td>
							</tr>
							<tr>
					...
					<table class="table table-bordered">
						...
						<tbody>
							<tr>
								...
								<td colspan="3">
										Perjalanan Dinas {!! $dinasbopsekretaris->dinasbop->kegiatan->nama_kegiatan !!}, selama {!! $durasi !!} hari dari tanggal {!! Carbon\Carbon::parse($dinasbopsekretaris->dari)->formatLocalized('%d %B %Y') !!}
										s.d {!! Carbon\Carbon::parse($dinasbopsekretaris->sampai)->formatLocalized('%d %B %Y') !!}.
								</td>
							</tr>
							<tr>
