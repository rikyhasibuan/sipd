				...
				<center>
					<table width="75%">
						<tr>
							...
							<td style="width:70%;vertical-align: top;text-align: justify;">PENERIMAAN BIAYA OPERASIONAL INSPEKTORAT BELANJA {!! strtoupper($dinasbopsekretaris->dinasbop->belanja->nama_belanja) !!} SELAMA {!! $durasi !!} ({!! strtoupper($common->terbilang($durasi)) !!}) HARI MULAI TANGGAL {!! strtoupper(Carbon\Carbon::parse($dinasbopsekretaris->dari)->formatLocalized('%d %B %Y')) !!} SAMPAI DENGAN {!! strtoupper(Carbon\Carbon::parse($dinasbopsekretaris->sampai)->formatLocalized('%d %B %Y')) !!} UNTUK MELAKUKAN {!! strtoupper($dinasbopsekretaris->dinasbop->program->nama_program) !!} PADA {!! strtoupper($dinasbopsekretaris->auditan) !!}</td>
						</tr>
					</table>
				</center>
				<br>
				<table class="table table-bordered">
					...
					<tbody>
						<tr>
							...
							<td>{!! $dinasbopsekretaris->driver['nama'] !!}</td>
