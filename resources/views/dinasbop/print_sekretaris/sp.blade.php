    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <h4 class="text-center">No. {!! $dinasbopsekretaris->nomor_sp !!}</h4>
                ...
                <div style="padding-left:0.5cm;padding-right:0.5cm;">
                        ...
                        <tr>
                            ...
                            <td width="80%" style="text-align: justify; vertical-align:text-top;">
                                <table cellpadding="2" cellspacing="2" style="width:100%;table-layout:fixed;">
                                    @if(count($dinasbopsekretaris->dasar) > 1)
                                        <?php $n = 0; ?>
                                        @foreach($dinasbopsekretaris->dasar as $v)
                                            <tr>
                    ...
                    <table cellpadding="2" cellspacing="2" style="width:100%;">
                        <tr>
                            ...
                            <td width="80%" style="text-align: justify;">
                                ...
                                <span style="margin-right:5px;">{!! $dinasbopsekretaris->sekretaris['nama'] !!}</span>
                                <br>
                                <span style="margin-right:31px;">Pangkat / Golongan </span>
                                <span style="margin-right:20px;">:</span>
                                <span style="margin-right:5px;">{!! $dinasbopsekretaris->sekretaris['pangkat'] !!} {!! $dinasbopsekretaris->sekretaris['golongan'] !!}</span>
                                <br>
                                <span style="margin-right:132px;">NIP </span>
                                <span style="margin-right:20px;">:</span>
                                <span style="margin-right:5px;">{!! $dinasbopsekretaris->sekretaris['nip'] !!}</span>
                                <br>
                                <span style="margin-right:110px;">Jabatan</span>
                                <span style="margin-right:20px;">:</span>
                                <span style="margin-right:5px;">Wakil Penanggungjawab</span>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table cellpadding="2" cellspacing="2" style="width:100%;">
                        <tr>
                            ...
                            <td width="80%" style="text-align: justify; vertical-align:text-top;">
                                <table cellpadding="2" cellspacing="2" style="width:100%;table-layout:fixed;">
                                    @if(count($dinasbopsekretaris->tujuan) > 1)
                                        <?php $n = 0; ?>
                                        @foreach($dinasbopsekretaris->tujuan as $v)
                                            <tr>
                                                <td width="3%" style="text-align: left; vertical-align:text-top;">{!! ++$n !!}.</td>
                                                <td width="95%" style="text-align: justify; vertical-align:text-top;">
                                                    {!! $v !!}
                    ...
                    <table cellpadding="2" cellspacing="2" style="width:100%;">
                        <tr>
                            ...
                            <td width="5%" style="text-align: center; vertical-align:text-top;">:</td>
                            <td width="80%" style="text-align: justify; vertical-align:text-top;">
                                Mulai tanggal {!! Carbon\Carbon::parse($dinasbopsekretaris->dari)->formatLocalized('%d %B %Y') !!} 
                                sampai {!! Carbon\Carbon::parse($dinasbopsekretaris->sampai)->formatLocalized('%d %B %Y') !!}
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td width="25%">
                                ...
                                <table cellpadding="2" cellspacing="2" style="width:100%;">
                                    <tr>
                                        <td width="20%" style="text-align: center;"><b>INSPEKTUR DAERAH PROVINSI JAWA BARAT</b></td>
                                    </tr>
                                    <tr>
