            ...
            <div style="padding-left:0.5cm;padding-right:0.5cm;">
                ...
                <table cellpadding="2" cellspacing="2" style="width:100%;">
                    <tr>
                        ...
                        <td width="5%" style="text-align: center; vertical-align:text-top;">:</td>
                        <td width="80%" style="text-align: justify; vertical-align:text-top;">
                            Mulai tanggal {!! $common->generate_indonesia_date($dinasbopsekretaris->dari) !!}
                            sampai {!! $common->generate_indonesia_date($dinasbopsekretaris->sampai) !!}
                        </td>
                    </tr>
                </table>
                        ...
                        <td width="25%">
                            <table cellpadding="2" cellspacing="2" style="width:100%;">
                                ...
                                <tr>
                                    ...
                                    <td width="10%" style="text-align: right;">{!! $common->generate_indonesia_date($dinasbopsekretaris->tgl_sp) !!}</td>
                                </tr>
                            </table>
                            <table cellpadding="2" cellspacing="2" style="width:100%;">
                                <tr>
