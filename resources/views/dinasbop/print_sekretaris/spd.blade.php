...
$diff = date_diff($dinasbopsekretaris->dinasbop->dari, $dinasbopsekretaris->dinasbop->sampai);
$durasi = $diff->days;
$kpa = $timdinas->get_sekretaris();
$total = $dinasbopsekretaris->dinasbop->total_anggaran;
?>
    <!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <table class="table table-bordered" style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    {!! $dinasbopsekretaris->sekretaris['nama'] !!}<br>
                                    {!! $dinasbopsekretaris->sekretaris['nip'] !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    {!! $dinasbopsekretaris->sekretaris['pangkat'] !!}
                                    {!! $dinasbopsekretaris->sekretaris['golongan'] !!}<br>
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">{!! $dinasbopsekretaris->tujuan[0] !!}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="60%" colspan="2">Kota Bandung<br> {!! $dinasbopsekretaris->dinasbop->auditan !!}
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td width="60%" colspan="2">
                                    ...
                                    {!! $common->generate_indonesia_date($dinasbopsekretaris->dari) !!} <br>
                                    {!! $common->generate_indonesia_date($dinasbopsekretaris->sampai) !!}
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td width="10%" style="text-align: right;">
                                                {!! $common->generate_indonesia_date($dinasbopsekretaris->tgl_sp) !!}</td>
                                        </tr>
                                    </table>
                                    <table style="width: 100%;">
                                        <tr>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    ...
                                    <tr>
                                        ...
                                        <td>: {!! $common->generate_indonesia_date($dinasbopsekretaris->dari) !!}</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td>: {!! $dinasbopsekretaris->dinasbop->auditan !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:2%;"></td>
                            ...
                            <td style="width:50%;">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td>
                                            : {!! $dinasbopsekretaris->dinasbop->auditan !!}<br>
                                            : Kota Bandung
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:60%;">Pada Tanggal</td>
                                        <td>: {!! $common->generate_indonesia_date($dinasbopsekretaris->sampai) !!}</td>
                                    </tr>
                                    <tr>
                            ...
                            <td colspan="2">
                                <table class="table-print">
                                    <tr>
                                        ...
                                        <td style="width:15%;">Tiba kembali di </td>
                                        <td>: Kota Bandung</td>
                                    </tr>
                                    <tr>
                                        <td style="width:2%;"></td>
                                        <td style="width:14%;">Pada Tanggal</td>
                                        <td>: {!! $common->generate_indonesia_date($dinasbopsekretaris->sampai) !!}</td>
                                    </tr>
                                    <tr>
                                        <td style="width:2%;"></td>
