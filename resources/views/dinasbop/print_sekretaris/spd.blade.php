							...
							<table class="table table-bordered" style="width: 100%;">
								...
								<tr>
									...
									<td width="60%" colspan="2">
										...
										{!! Carbon\Carbon::parse($dinasbopsekretaris->dari)->formatLocalized('%d %B %Y') !!} <br> 
										{!! Carbon\Carbon::parse($dinasbopsekretaris->sampai)->formatLocalized('%d %B %Y') !!} 
									</td>
								</tr>
								<tr>
								...
								<td style="width:50%;">
									<table class="table-print">
										...
										<tr>
												...
												<td>: {!! Carbon\Carbon::parse($dinasbopsekretaris->dari)->formatLocalized('%d %B %Y') !!}</td>
										</tr>
									</table>
								</td>
							</tr>
							<tr>
								...
								<td style="width:50%;">
									<table class="table-print">
										...
										<tr>
												<td style="width:60%;">Pada Tanggal</td>
												<td>: {!! Carbon\Carbon::parse($dinasbopsekretaris->sampai)->formatLocalized('%d %B %Y') !!}</td>
										</tr>
										<tr>
