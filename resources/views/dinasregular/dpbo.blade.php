        ...
        <div class="col-md-12">
            ...
            <table width="95%">
                <tr>
                    ...
                    <td style="width:70%;vertical-align: top;text-align: justify;">PENERIMAAN UANG HARIAN DAN TRANSPORTASI UNTUK {!! strtoupper($dinasregular->belanja->nama_belanja) !!} SELAMA {!! $durasi !!} ({!! strtoupper($common->terbilang($durasi)) !!}) HARI MULAI TANGGAL {!! strtoupper($common->generate_indonesia_date($dinasregular->dari)) !!} SAMPAI DENGAN {!! strtoupper($common->generate_indonesia_date($dinasregular->sampai)) !!} UNTUK MELAKUKAN {!! strtoupper($dinasregular->program->nama_program) !!} PADA {!! strtoupper($dinasregular->auditan) !!}</td>
                </tr>
            </table>
            <br>
                            ...
                            <table cellpadding="2" cellspacing="2" style="width:30%;">
                                <tr>
                                    <td width="10%" style="text-align: center;">
                                        Bandung, {!! $common->generate_indonesia_date($dinasregular->tgl_sp) !!}
                                    </td>
                                </tr>
                            </table>
                        </center>
