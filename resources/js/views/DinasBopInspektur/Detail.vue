<template>
    <div style="margin-top:25px;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pull-left">
                    <a :href="route + '/inspektur/create?dinasbop=' + dinasbop.id" class="btn btn-success mb-2"><i class="fa fa-plus"></i> Tambah Data</a>
                </div>
            </div>
        </div>
        <div class="row">
...
export default {
    ...
    props: ['dinasbop','dinasbopinspektur', 'route', 'print_action', 'api'],
    methods: {
        print_sp(id) {
