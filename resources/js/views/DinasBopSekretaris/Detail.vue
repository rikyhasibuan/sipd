<template>
    <div style="margin-top:25px;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pull-left">
                    <a v-if="access.write === 1" :href="route + '/sekretaris/create?dinasbop=' + dinasbop.id" class="btn btn-success mb-2 mr-2"><i class="fa fa-plus"></i> Tambah Data</a>
                            ...
                            <tr v-for="v in dinasbopsekretaris" :key="v.id">
                                ...
                                <td style="text-align: center; vertical-align:middle;">
                                    <div style="text-align: center;">
                                        <a v-if="access.update === 1" :href="route + '/sekretaris/edit?dinasbop='+ dinasbop.id +'&id=' + v.id" class="btn btn-sm btn-warning mr-sm-1">
