                            ...
                            <table class="table table-hover table-striped table-bordered" v-if="showTable == true">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:10%; text-align:center;">Eselon II</th>
                                        <th style="width:10%; text-align:center;">Eselon III</th>
                                        <th style="width:15%; text-align:center;">Fungsional Madya</th>
                                        <th style="width:15%; text-align:center;">Eselon IV, Gol. IV dan Gol. III</th>
                                        <th style="width:10%; text-align:center;">Gol. II dan Gol. I</th>
                                ...
                                <tbody>
                                    <tr v-for="v in akomodasi" :key="v.id">
                                        ...
                                        <td style="text-align:right;">{{ v.eselon_2 | rupiah }}</td>
                                        <td style="text-align:right;">{{ v.eselon_3 | rupiah }}</td>
                                        <td style="text-align:right;">{{ v.madya | rupiah }}</td>
