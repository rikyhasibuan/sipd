        ...
        <div class="row" >
            <div class="col-md-12">
                <div class="pull-left" v-if="emptyData === false">
                    <a v-if="approval_tab.lock === 0 && access.update === 1" :href="route + '/pengumpuldata/edit?id='+dinasboppengumpuldata.id+'&dinasbop=' + dinasbop.id" class="btn btn-warning mb-2 mr-2"><i class="fa fa-wrench"></i> Ubah Data Dinas</a>
                    <a v-if="approval_tab.lock === 0 && access.write === 1" :href="route + '/timpengumpuldata/create?pengumpuldata='+dinasboppengumpuldata.id+'&dinasbop=' + dinasbop.id" class="btn btn-success mb-2 mr-2"><i class="fa fa-plus"></i> Tambah Tim Pengumpul Data</a>

                    <span v-if="dinasboptimpengumpuldata.length !== 0 && access.approval === 1">
