<template>
    <div style="margin-top:25px;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pull-left">
                    <a v-if="approval_tab.lock === 0 && access.write === 1" :href="route + '/driver/create?dinasbop=' + dinasbop.id" class="btn btn-success mb-2 mr-2"><i class="fa fa-plus"></i> Tambah Pengemudi</a>
                    <span v-if="dinasbopdriver.length !== 0 && access.approval === 1">
                            ...
                            <tr v-for="v in dinasbopdriver" :key="v.id">
                                ...
                                <td style="text-align: center; vertical-align:middle;">
                                    <div style="text-align: center;">
                                        <a v-if="approval_tab.lock === 0 && access.update === 1" :href="route + '/driver/edit?dinasbop='+ dinasbop.id +'&id=' + v.id" class="btn btn-sm btn-warning mr-sm-1">
