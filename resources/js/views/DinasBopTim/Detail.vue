<template>
    ...
    <div class="row">
        <div class="col-md-12">
            <hr>
            <div class="pull-left">
                <a v-if="(approval_tab.lock === 0 && access.write === 1) && (dinasbop.status === 0 && access.write === 1)" :href="route + '/tim/create?dinasbop=' + dinasbop.id" class="btn btn-success mb-2 mr-2"><i class="fa fa-plus"></i> Tambah Tim</a>

                <span v-if="dinasboptim.length > 0">
                    <a v-if="approval_tab.lock === 1 || dinasbop.status === 1" class="btn btn-default mb-2 mr-2" href="#" @click="print_personil_all(dinasbop.id)">
                        <i class="fa fa-users"></i> Cetak Daftar Personil</a>
                </span>

                <span v-if="dinasboptim.length !== 0 && access.approval === 1 && dinasbop.status === 0">
                        ...
                        <tr v-for="v in dinasboptim" :key="v.id">
                            ...
                            <td style="text-align: center; vertical-align:middle;">
                                <div style="text-align: center;">
                                    <a v-if="(approval_tab.lock === 0 && access.update === 1) && (dinasbop.status === 0 && access.update === 1)" :href="route + '/tim/edit?dinasbop='+ dinasbop.id +'&id=' + v.id" class="btn btn-sm btn-warning mr-sm-1">
