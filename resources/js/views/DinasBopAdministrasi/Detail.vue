        ...
        <div class="row" >
            <div class="col-md-12">
                <div class="pull-left" v-if="emptyData === false">
                    <a v-if="approval_tab.lock === 0 && access.update === 1" :href="route + '/administrasi/edit?id='+dinasbopadministrasi.id+'&dinasbop=' + dinasbop.id" class="btn btn-warning mb-2 mr-2"><i class="fa fa-wrench"></i> Ubah Data Dinas</a>
                    <a v-if="approval_tab.lock === 0 && access.write === 1" :href="route + '/timadministrasi/create?administrasi='+dinasbopadministrasi.id+'&dinasbop=' + dinasbop.id" class="btn btn-success mb-2 mr-2"><i class="fa fa-plus"></i> Tambah Tim Pengadministrasi</a>
                        ...
                        <tr v-for="v in dinasboptimadministrasi" :key="v.id">
                            ...
                            <td style="text-align: center; vertical-align:middle;">
                                <div style="text-align: center;">
                                    <a v-if="approval_tab.lock === 0 && access.update === 1" :href="route + '/timadministrasi/edit?administrasi='+ v.dinasbop_administrasi_id +'&id=' + v.id" class="btn btn-sm btn-warning mr-sm-1">
