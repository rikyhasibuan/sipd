            ...
            <div class="col-lg-12">
                <div class="card table-responsive">
                    ...
                    <div class="card-body">
                            ...
                            <table class="table table-hover table-striped table-bordered" v-if="showTable === true">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:40%; text-align:center;">Kabupaten / Kota</th>
                                        <th style="width:10%; text-align:center;">Action</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr v-for="v in irbankabkota" :key="v.id">
                        ...
                        <transition name="fade"><v-delete :element="'irbankabkota_delete_modal'" :id="id" @delete="deleteData"></v-delete></transition>
                        <transition name="fade">
...
export default {
    ...
    methods: {
        ...
        toggleModal(id) {
            $("#irbankabkota_delete_modal").modal('show');
            this.id = id;
        },
        fetchData() {
            this.isLoading = true;
        ...
        renderData(response) {
            if (response.total === 0) {
                ...
                this.alert.error = false;
                this.irbankabkota = response.data;
        ...
        deleteData(id) {
            ...
            .then(response => {
                if(response.status === 'ok') {
                    ...
                    $('#irbankabkota_delete_modal').modal('hide');
                    this.fetchData();
