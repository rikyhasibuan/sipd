...
<script>
    ...
    export default {
        ...
        created() {
            ...
            this.isLoading = true;
            this.tim.auditan = this.dinasboptimadministrasi.auditan;
            this.tim.nomor_sp = this.dinasboptimadministrasi.nomor_sp;
            this.tim.tgl_sp = this.dinasboptimadministrasi.tgl_sp;
            this.tim.ketuatim = this.dinasboptimadministrasi.tim.ketuatim.nip;

            let anggota_list = this.dinasboptimadministrasi.tim.anggota;
